...
cd $BASE_DIR
7za a -mx9 -t7z "$BASE_DIR/result/android-gdc(windows_x86_64)[$hg_revision:$hg_id:$dmd_ver].7z" android-ndk-r7/toolchains/arm-linux-androideabi-4.6.2/prebuilt/windows_64/
